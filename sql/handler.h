...
enum row_type {
    ROW_TYPE_NOT_USED = -1, ROW_TYPE_DEFAULT, ROW_TYPE_FIXED,
...
enum ha_stat_type {
    HA_ENGINE_STATUS, HA_ENGINE_LOGS, HA_ENGINE_MUTEX
};
...
private:
    enum {
        TRX_READ_ONLY = 0, TRX_READ_WRITE = 1
    };
...
enum enum_ha_unused {
    HA_CHOICE_UNDEF, HA_CHOICE_NO, HA_CHOICE_YES
};
...
public:
    ...
    */
    ...
    virtual double scan_time() { return ulonglong2double(stats.data_file_length) / IO_SIZE + 2; }

    virtual double read_time(uint index, uint ranges, ha_rows rows) { return rows2double(ranges + rows); }

    virtual const key_map *keys_to_use_for_scanning() { return &key_map_empty; }

    bool has_transactions() { return (ha_table_flags() & HA_NO_TRANSACTIONS) == 0; }
    ...
    */
    virtual ha_rows estimate_rows_upper_bound() { return stats.records + EXTRA_RECORDS; }
    ...
    */
    ...
    virtual int index_prev(uchar *buf) { return HA_ERR_WRONG_COMMAND; }

    virtual int index_first(uchar *buf) { return HA_ERR_WRONG_COMMAND; }

    virtual int index_last(uchar *buf) { return HA_ERR_WRONG_COMMAND; }
    ...
    */
    ...
    /**
      ...
      tables during joins.
    */
    virtual int restart_rnd_next(uchar *buf, uchar *pos) { return HA_ERR_WRONG_COMMAND; }
    ...
    */
    virtual bool is_fk_defined_on_table_or_index(uint index) { return FALSE; }

    virtual char *get_foreign_key_create_info() { return (NULL); }  /* gets foreign key create string from InnoDB */
    virtual char *
    get_tablespace_name(THD *thd, char *name, uint name_len) { return (NULL); }  /* gets tablespace name from handler */
    ...
    */
    virtual int
    get_foreign_key_list(THD *thd, List<FOREIGN_KEY_INFO> *f_key_list) { return 0; }
    ...
    */
    virtual int
    get_parent_foreign_key_list(THD *thd, List<FOREIGN_KEY_INFO> *f_key_list) { return 0; }
...
*/
    virtual int add_index(TABLE *table_arg, KEY *key_info, uint num_of_keys,
                          handler_add_index **add) { return (HA_ERR_WRONG_COMMAND); }
...
*/
    virtual int final_add_index(handler_add_index *add, bool commit) { return (HA_ERR_WRONG_COMMAND); }

    virtual int prepare_drop_index(TABLE *table_arg, uint *key_num,
                                   uint num_of_keys) { return (HA_ERR_WRONG_COMMAND); }

    virtual int final_drop_index(TABLE *table_arg) { return (HA_ERR_WRONG_COMMAND); }
...
#define CHF_INDEX_FLAG  3
    ...
    */
    ...
    virtual bool check_if_incompatible_data(HA_CREATE_INFO *create_info,
                                            uint table_changes) { return COMPATIBLE_DATA_NO; }
...
private:
    ...
    */
    ...
    virtual int check_for_upgrade(HA_CHECK_OPT *check_opt) { return 0; }
    ...
    */
    ...
    virtual int index_read(uchar *buf, const uchar *key, uint key_len,
                           enum ha_rkey_function find_flag) { return HA_ERR_WRONG_COMMAND; }

    virtual int
    index_read_last(uchar *buf, const uchar *key, uint key_len) { return (my_errno = HA_ERR_WRONG_COMMAND); }
    ...
    */
    virtual int truncate() { return HA_ERR_WRONG_COMMAND; }
    ...
    */
    ...
    virtual int discard_or_import_tablespace(my_bool discard) { return (my_errno = HA_ERR_WRONG_COMMAND); }
    ...
    virtual int create_handler_files(const char *name, const char *old_name,
                                     int action_flag, HA_CREATE_INFO *info) { return FALSE; }
    ...
    virtual int change_partitions(HA_CREATE_INFO *create_info,
                                  ...
                                  ulonglong *const deleted,
                                  const uchar *pack_frm_data,
                                  size_t pack_frm_len) { return HA_ERR_WRONG_COMMAND; }

    virtual int drop_partitions(const char *path) { return HA_ERR_WRONG_COMMAND; }

    virtual int rename_partitions(const char *path) { return HA_ERR_WRONG_COMMAND; }
};
